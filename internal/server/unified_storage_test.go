...
func TestTunnelStorePreservesExplicitServerExposeBindIP(t *testing.T) {
	...
	stored := StoredTunnel{
		...
		Ingress:         EndpointSpec{Location: protocol.EndpointLocationServer, Type: TunnelIngressTypeTCPListen},
		Target:          EndpointSpec{Location: protocol.EndpointLocationClient, ClientID: "client-1", Type: TunnelTargetTypeTCPService},
